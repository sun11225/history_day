...
public class ADMainActivity extends BaseActivity implements View.OnClickListener {
...
//        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ADMainActivity.this, HistoryDescActivity.class);
                //获取详细事件的id传递
...
//            Toast.makeText(ADMainActivity.this,"没有权限！",Toast.LENGTH_LONG).show();
            Intent intent = new Intent(ADMainActivity.this, HistoryActivity.class);
